...
### 변수의 scope와 스코프 체인
  ...
  * 호이스팅 : 변수 선언이 맨위로 끌어욜려지기 때문에 전역변수로 처리 [02func_08_01_hoisting.html](02func_08_01_hoisting.html)
  * 함수안에 변수명을 중복선언하는 경우 가장 가까운 위치에 선언된 변수를 사용. [02func_08_02_duplicate.html](02func_08_02_duplicate.html)
  * 호출한 함수를 역으로 따라 올라 가면서 변수를 찾고 최종적으로 전역변수를 찾게 된다. [02func_08_03_scopechain.html](02func_08_03_scopechain.html)
