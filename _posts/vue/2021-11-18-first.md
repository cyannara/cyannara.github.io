...
* [참고사이트: Vue.js 입문서](https://joshua1988.github.io/web-development/vuejs/vuejs-tutorial-for-beginner/){:target="_blank"}  
![vvmv](/img/vue/view-model.png){:width="800px"}
...
* setup()
  * props, context 매개변수를 가진다
* &lt;script setup&gt;
  * setup함수에서 반복적으로 사용되는 내용을 줄여준다.
...
export default {
    name : 'NavVar',
    setup() {
        const curMenu = ref('home')
        const menus = [ 
            { key: 'home',    value: '홈',        url: '/home' },
            { key: 'board',   value: '게시판',    url: '/board'},
            { key: 'profile', value: 'Profile',   url: '/profile'},
        ]
        const onmovePage = (menu_object) => { menu.value = menu_object.key  }
        return {  curMenu, onmovePage ,menus }
    },
}
</script>
```  
