...
6. 이클립스에 lombokjar 추가
   - 이클립스 종료
   - C:\Users\user\.m2\repository\org\projectlombok\lombok\1.18.24\lombok-1.18.24.jar 파일 실행
   - eclipse 실행파일 추가
   - eclipse.ini 파일에 "-javaagent:D:\dev\eclipse\lombok.jar" 설정이 자동으로 추가됨.
   - 이클립스 실행
